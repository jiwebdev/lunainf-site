...
There are 14 corridors containing 35 relationships. Ribbon width in SVG units is 3 + 3 * sqrt(count), with a five-unit wider pale halo and a one-unit highlight. All corridors are derived, with no authored connectivity.
